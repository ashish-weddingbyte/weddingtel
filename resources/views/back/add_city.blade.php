        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <!-- /.card-header -->  
                    <form class="form-horizontal" method="post" action="{{ url('/byte/city/save_city') }}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="city_name" class="col-sm-2 col-form-label">City Name</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="city_name" id="city_name" placeholder="City Name" value="{{ old('city_name') }}">
                                @error('city_name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="state_name" id="state_name" placeholder="State Number" value="{{ old('state_name') }}">
                                @error('state_name')
                                    <span class="text text-danger">{{ $message }}</span>
                                @enderror
                                </div>
