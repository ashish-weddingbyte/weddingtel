        ...
        <div class="col-12">
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <input type="button" data-action-type="activate" data-action="{{ url('byte/category/action') }}" class="btn btn-outline-info submit" value="Activate Category" >

                    <input type="button" data-action-type="deactivate" data-action="{{ url('byte/category/action') }}" class="btn btn-outline-danger submit" value="De-Activate Category" >

                    <input type="button" data-action-type="delete" data-action="{{ url('byte/category/action') }}" class="btn btn-outline-danger submit" value="Soft Delete" >
