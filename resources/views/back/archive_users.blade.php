    ...
    <div class="container-fluid">
        ...
        <div class="col-12">
            ...
            <div class="card-header">
                <h3 class="card-title">Archive Bride/Groom</h3>
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <input type="button" data-action-type="force_delete_user" data-action="{{ url('byte/vendors/action') }}" class="btn btn-outline-danger submit" value="Hard Delete Vendor" >
