...
@section('title', 'Buy Position Plan')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Buy Position Plan</li>
            </ol>
          </div>
        </div>
        <div class="mt-3">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">Buy Position Plan</h3>
                                ...
                                <div class="col-sm-10">
                                    <select name="plan" id="plan" class="form-control">
                                        ...
                                        @foreach($plans as $plan)
                                            <option value="{{$plan->id}}">{{ $plan->name }} | {{ ucwords($plan->position) }} | {{ $plan->price }} INR | {{ $plan->days }} Days</option>
                                        @endforeach
                                    </select>
                                    @error('plan')
                                        <span class="text text-danger">{{ $message }}</span>
