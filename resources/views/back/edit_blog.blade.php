                ...
                <div class="col-12">
                    ...
                    <form class="form-horizontal" method="post" action="{{ url('/byte/blog/save_blog') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="title" id="title" placeholder="Blog Title" value="{{ old('title',$blog->title) }}">
                            @error('title')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                @error('image')
                                    <span class="text text-danger">{{ $message }}</span>
                                @enderror
                                <img src="{{ asset('storage/upload/blog/'.$blog->featured_image)}}" alt="{{ $blog->featured_image }}" class="mt-1" height="400px" width="300px">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="short_desc" id="short_desc" class="form-control" cols="20" rows="5" placeholder="Blog Short Description">{{ old('short_desc',$blog->short_desc) }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="desc" id="desc" class="form-control" cols="20" rows="5" placeholder="Blog Description">{{ old('desc',$blog->desc) }}</textarea>
                                @error('desc')
                                    <span class="text text-danger">{{ $message }}</span>
                                @enderror
                            </div>
