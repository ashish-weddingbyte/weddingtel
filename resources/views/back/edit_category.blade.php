        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <!-- /.card-header --> 
                    @if($category) 
                    <form class="form-horizontal" method="post" action="{{ url('/byte/category/update') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="name" class="col-sm-2 col-form-label">Category Name</label>
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" id="name" placeholder="Category Name" value="{{ old('name',$category->category_name) }}">
                                @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="icon" id="icon" placeholder="<i class='fa fa-user'></i>" value="{{ old('icon',$category->icon) }}">
