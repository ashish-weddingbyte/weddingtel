...
@section('title', 'All Expired Paid Vendors')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>All Expired Paid Vendors</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">All Expired Paid Vendors</li>
            </ol>
          </div>
        </div>
        <div class="mt-3">
        ...
        <div class="col-12">
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <hr />
                    <input type="button" data-action-type="active_position_plan" data-action="{{ url('byte/vendors/action') }}" class="btn btn-outline-success submit" value="Mark Active Plan" >
