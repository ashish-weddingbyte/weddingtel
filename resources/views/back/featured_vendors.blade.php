...
@section('title', 'All Featured Vendors')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">All Featured Vendors</li>
            </ol>
          </div>
        </div>
        <div class="mt-3">
    ...
    <div class="container-fluid">
        ...
        <div class="col-12">
            ...
            <div class="card-header">
                <h3 class="card-title">All Featured Vendors</h3>
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <hr />
                    <input type="button" data-action-type="remove_featured" data-action="{{ url('byte/vendors/action') }}" class="btn btn-outline-info submit" value="Remove Top Vendors">
                </form>
            </div>
            <!-- /.card-body -->
            </div>
