    ...
    <div class="container-fluid">
        ...
        <div class="col-12">
            ...
            <div class="card-header">
                <h3 class="card-title">All Featured Vendor List</h3>
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <hr />
                    <input type="button" data-action-type="remove_featured" data-action="{{ url('byte/vendors/all-vendors/action') }}" class="btn btn-outline-info submit" value="Remove Featured Vendors">
