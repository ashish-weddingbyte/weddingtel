...
@section('title', 'Lead Open Vendor List')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Lead Open Vendor List</li>
            </ol>
          </div>
        </div>
        <div class="mt-3">
            ...
            <div class="card-body">
                <div class="my-2">
                    <div class="position-relative p-3 bg-gray">
                        ...
                        <h3>{{ $lead->name }}</h3>
                        <span>{{ $lead->mobile }}</span> | <span>{{ $lead->budget }}</span> | <span>{{ $lead->city }}</span>
                    </div>
                </div>
                <hr>
                        ...
                        <table  class="table table-bordered table-striped dataTable">
                            ...
                            <tbody>
                                @if($vendors)
                                    ...
                                    ?>
                                        <tr>
                                            <td><input type="checkbox" class="sub_chk" data-id="{{ $vendor->user_id }}"></td>
                                            <td>
