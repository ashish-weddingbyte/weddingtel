...
@section('title', 'All Un-Approved Leads')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">All Un-Approved Leads</li>
            </ol>
          </div>
        </div>
        <div class="mt-3">
    ...
    <div class="container-fluid">
        ...
        <div class="col-12">
            ...
            <div class="card-header">
                <h3 class="card-title">All Un-Approved Leads</h3>
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <hr />
                    <input type="button" data-action-type="approved" data-action="{{ url('byte/leads/action') }}" class="btn btn-outline-secondary submit" value="Approve Leads" >
