...
@section('title', 'Exclusive Lead Details')
        ...
        <div class="card-shadow mt-dashboard">
            <div class="card-shadow-header">
                <div class="dashboard-head">
                    <h3>
                        Exclusive Lead Details
                    </h3>
                    <div class="links">
                        <a href="{{ url('vendor/exclusive-leads') }}">View All <i class="fa fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
